...
### Stack
A pilha de funções (_[stack](https://blog.pantuza.com/artigos/tipos-abstratos-de-dados-pilha-stack)_) é uma área da memória que aloca dados/variáveis ou ponteiros quando uma função é chamada e desalocada quando a função termina. Podemos dizer então que representa a memória local àquela função.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzE4MzkzOTU3LC01MDI2MDU1MThdfQ==
-->