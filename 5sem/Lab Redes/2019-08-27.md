...
- 1ª Regra:
	...
	- 1 = bit para rede
- 2ª Regra:
	- Calcular sub-redes = 2^n^ (numero de bits 1 (um))
	- Calcular hosts = 2ⁿ - 2 (numero de bits 0 (zero))

Toda rede ou sub-rede possui 2 endereços reservados:
- 1º endereço do intervalo: reservado para identificar a rede ou sub-rede
- Último endereço do intervalo: reservado para broadcast
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzA0NDc0MTEwLDE1NDU2MTU3ODksLTIwMz
kzMDYyODcsLTE1NzM5OTk4MDJdfQ==
-->